package org.xtimms.kitsune.widget
...
import org.xtimms.kitsune.databinding.EmptyViewBinding
import org.xtimms.kitsune.util.system.getThemeColor
...
class EmptyView @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) :
    ...
    fun show(@DrawableRes icon: Int, message: String, actions: List<Action>? = null) {
        ...
        val buttonContext = ContextThemeWrapper(context, R.style.Widget_Kitsune_Button_ActionButton)
